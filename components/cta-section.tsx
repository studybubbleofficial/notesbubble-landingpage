...
export function CTASection() {
  return (
    <section className="w-full pt-20 md:pt-60 lg:pt-60 pb-10 md:pb-20 px-5 relative flex flex-col justify-center items-center overflow-visible">
      <div className="absolute top-0 left-1/3 w-[500px] h-[300px] gradient-orb rounded-full blur-3xl opacity-40" />
      <div
        className="absolute bottom-1/4 right-1/3 w-[400px] h-[250px] gradient-orb rounded-full blur-3xl opacity-35"
      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          ...
          <p className="text-muted-foreground text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl">
            Join thousands of Singapore students who've discovered the power of quality, trusted study materials. Start
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          ...
          <Link href="/pricing">
            <Button
              variant="outline"
              className="px-[30px] py-2 text-base font-medium leading-6 rounded-[99px] transition-all duration-200 bg-transparent"
              size="lg"
            >
              View Pricing
            </Button>
