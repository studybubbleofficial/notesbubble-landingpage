  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-1/4 left-1/4 w-96 h-96 gradient-orb rounded-full blur-3xl" />
        <div
          className="absolute bottom-1/4 right-1/4 w-80 h-80 gradient-orb rounded-full blur-3xl"
      ...
      <div className="relative z-10 space-y-4 md:space-y-5 lg:space-y-6 mb-6 md:mb-7 lg:mb-9 max-w-md md:max-w-[500px] lg:max-w-[588px] mt-16 md:mt-[120px] lg:mt-[160px] px-4">
        ...
        <p className="text-muted-foreground text-base md:text-base lg:text-lg font-medium leading-relaxed max-w-lg mx-auto">
          Search, trust, and share notes across Sec, JC, Poly, and Uni.
        </p>
      </div>

      <div className="relative z-10 flex flex-col sm:flex-row gap-4 items-center">
        <Link href="/catalogue" className="w-full sm:w-auto">
          <Button className="relative z-10 bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-3 rounded-full font-medium text-base shadow-lg ring-1 ring-white/10 w-full sm:w-auto">
            Search notes
          </Button>
        </Link>
        <Link href="/upload" className="w-full sm:w-auto">
          <Button
            variant="outline"
            className="relative z-10 bg-transparent border-2 border-foreground/20 text-foreground hover:bg-foreground/5 px-8 py-3 rounded-full font-medium text-base shadow-lg w-full sm:w-auto"
          >
            Upload notes
          </Button>
        </Link>
